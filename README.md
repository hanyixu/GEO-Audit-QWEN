<p align="center">
  <img src="assets/banner.svg" alt="GEO 智能引擎优化技能包" width="900"/>
</p>
...
<p align="center">
  <strong>🇨🇳 中国优先：</strong>专为中文互联网生态设计，同时兼容全球 AI 平台
</p>
...
| 特性 | 说明 |
|------|------|
| 🇨🇳 **中国优先** | 专为中文互联网生态设计，覆盖豆包/元宝/千问/Kimi/DeepSeek/百度 |
...
```bash
curl -fsSL https://raw.githubusercontent.com/hanyixu/geo-seo-claude-CN/main/install.sh | bash
```
...
```bash
# 方式一：一键安装
curl -fsSL https://raw.githubusercontent.com/hanyixu/geo-seo-claude-CN/main/install-win.sh | bash
...
- **Python 3.8+**
- **Qwen Code CLI**（通义千问代码工具）或 Claude Code CLI
- **Git**
...
> **💡 重要提示：** 本工具完美支持 Qwen Code（通义千问代码助手），所有功能均可在千问本地运行，**数据不出境**，完全符合中国企业数据安全要求。
...
| 🇨🇳 **中文优化** | 专为中文互联网生态设计，覆盖百度百科/微信/知乎/小红书等 |
...
- 报告 Bug → [新建 Issue](https://github.com/hanyixu/geo-seo-claude-CN/issues)
- 功能建议 → [功能请求](https://github.com/hanyixu/geo-seo-claude-CN/issues)
- 代码贡献 → [Fork 并提交 PR](https://github.com/hanyixu/geo-seo-claude-CN/pulls)

---

## 📞 联系

- GitHub: [https://github.com/hanyixu/geo-seo-claude-CN](https://github.com/hanyixu/geo-seo-claude-CN)
- 问题反馈: [新建 Issue](https://github.com/hanyixu/geo-seo-claude-CN/issues)
